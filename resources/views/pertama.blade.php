...
<a href="#">Halaman ini</a>
        ...
        <p>
            ...
            <a href="https://www.its.ac.id/si/">Coba klik disini</a>
        </p>
        <p>
            <table border="1">
                <tr>
                  <th colspan="3">Puasa Ramadhan</th>
                </tr>
                <td> Day 1</td>
                <td> Day 2</td>
                <td> Day 3 </td>
        ...
        <p>
            <input type="checkbox" name="agree" checked> Saya setuju dengan syarat dan ketentuan.
        </p>
        <p>
        ...
        <p>
            <img src="image/img4.jpg" alt="Deskripsi gambar">
        </p>
        <p>
        ...
        <p>
            ...
            width="500">
            <br> Maba ITS dalam kegiatan Mentoring Agama Islam Semester Genap 2024/2025 di Masjid Manarul Ilmi ITS
        </p>
        <p>
